          ...
          while($event_posts->have_posts()) {
            ...
            <div class="event-summary">
              ...
              <div class="event-summary__content">
                ...
                <p><?=wp_trim_words(get_the_content(), 15)?> <a href="<?php the_permalink(); ?>" class="nu gray">Learn more</a></p>
              </div>
            </div>
          <?php }
        ?>
          ...
          while ($homepage_posts->have_posts()) {
            ...
            <div class="event-summary">
              ...
              <div class="event-summary__content">
                ...
                <p><?=wp_trim_words(get_the_content(), 15)?> <a href="<?=the_permalink()?>" class="nu gray">Read more</a></p>
              </div>
            </div>
